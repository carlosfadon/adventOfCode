...
import org.example.year2024.util.IOUtil;

import java.util.*;
import java.util.stream.Collectors;

public class CopyDay21 {
...
//                new Character[]{'9', '6', '4', 'A'}
        toType = List.of("140A", "143A", "349A", "582A", "964A");
    //INPUT.lines().toList();
    }
